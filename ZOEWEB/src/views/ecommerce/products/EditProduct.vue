        ...
        <div class="card mt-4" data-animation="true">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <a class="d-block blur-shadow-image">
              <img
src="@/assets/img/products/product-11.jpg" alt="img-blur-shadow"
                class="img-fluid shadow border-radius-lg" />
            </a>
            <div
class="colored-shadow" style="
                background-image: url(&quot;@/assets/img/products/product-11.jpg&quot;);
              "></div>
          </div>
          <div class="card-body text-center">
            <div class="mt-n6 mx-auto">
              <button class="btn bg-gradient-success btn-sm mb-0 me-2" type="button" name="button">
                Edit
              </button>
      ...
      <div class="mt-4 col-lg-8 mt-lg-0">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row mt-4">
              <div class="col-3">
                <material-input id="collection" variant="dynamic" label="Collection" />
              </div>
              <div class="col-3">
      ...
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            ...
            <div class="col-12 mt-3">
              <material-input id="instagram" label="Instagram Handle" variant="dynamic" />
            </div>
          </div>
        </div>
      </div>
