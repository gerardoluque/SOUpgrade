...
namespace API.Persistence.Migrations
{
    ...
    [Migration("20251111035117_BorrarColumnas_Corporacion")]
    partial class BorrarColumnas_Corporacion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Domain.Catalogos.EstadoCivil", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Domain.Catalogos.NivelEducativo", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Domain.Seguridad.BaseDatos", b =>
                {
                    b.Property<short>("Id")
            ...
            modelBuilder.Entity("API.Domain.Seguridad.CorporacionSistemaBD", b =>
                {
            ...
            modelBuilder.Entity("API.Domain.Seguridad.Sistema", b =>
                {
                    b.Property<short>("Id")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("API.Domain.Seguridad.UserRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Domain.Ubicacion.EntidadFederativa", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Domain.Seguridad.CorporacionSistemaBD", b =>
                {
                    b.HasOne("API.Domain.Seguridad.BaseDatos", "BaseDatos")
                        .WithMany()
                    ...
                    b.HasOne("API.Domain.Seguridad.Sistema", "Sistema")
                        .WithMany()
