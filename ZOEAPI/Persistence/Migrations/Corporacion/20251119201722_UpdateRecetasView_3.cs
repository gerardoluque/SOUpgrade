...
{
    /// <inheritdoc />
    public partial class UpdateRecetasView_3 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                SELECT 
                    ...
                    CAST(JSON_VALUE(medicamento.value, '$.MedicamentoId') AS INT) AS MedicamentoId,
                    m.SustanciaActiva,
                ...
                LEFT JOIN dbo.Medicamentos m 
                    ON m.Id = CAST(JSON_VALUE(medicamento.value, '$.MedicamentoId') AS INT)
                LEFT JOIN dbo.MedicamentoClasificaciones AS mc 
                    ON m.ClasificacionId = mc.Id
                LEFT JOIN dbo.MedicamentoTipoControles AS mtc
				    ON mtc.Id = m.TipoControlId 
